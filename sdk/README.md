...
------------ | ------------- | ------------- | -------------
*AborApi* | [**add_diary_entry**](/sdk/docs/AborApi.md#add_diary_entry) | **POST** /api/abor/{scope}/{code}/accountingdiary/{diaryEntryCode} | [EXPERIMENTAL] AddDiaryEntry: Add a diary entry to the specified Abor.
