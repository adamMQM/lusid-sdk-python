...
equity_option_all_of_instance = EquityOptionAllOf.from_json(json)
# print the JSON string representation of the object
print EquityOptionAllOf.to_json()

# convert the object into a dict
equity_option_all_of_dict = equity_option_all_of_instance.to_dict()
# create an instance of EquityOptionAllOf from a dict
equity_option_all_of_form_dict = equity_option_all_of.from_dict(equity_option_all_of_dict)
```
