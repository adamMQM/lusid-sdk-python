...
async with api_client_factory:
    ...
    api_instance = api_client_factory.build(lusid.ReferencePortfolioApi)
    ...
    try:
        ...
        print("The response of ReferencePortfolioApi->create_reference_portfolio:\n")
        pprint(api_response)
...
async with api_client_factory:
    ...
    try:
        ...
        print("The response of ReferencePortfolioApi->get_reference_portfolio_constituents:\n")
        pprint(api_response)
    except Exception as e:
...
async with api_client_factory:
    ...
    try:
        ...
        print("The response of ReferencePortfolioApi->list_constituents_adjustments:\n")
        pprint(api_response)
    except Exception as e:
...
async with api_client_factory:
    ...
    try:
        ...
        print("The response of ReferencePortfolioApi->upsert_reference_portfolio_constituents:\n")
        pprint(api_response)
    except Exception as e:
