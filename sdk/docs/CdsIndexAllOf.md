...
json = "{}"
# create an instance of CdsIndexAllOf from a JSON string
cds_index_all_of_instance = CdsIndexAllOf.from_json(json)
# print the JSON string representation of the object
print CdsIndexAllOf.to_json()

# convert the object into a dict
cds_index_all_of_dict = cds_index_all_of_instance.to_dict()
# create an instance of CdsIndexAllOf from a dict
cds_index_all_of_form_dict = cds_index_all_of.from_dict(cds_index_all_of_dict)
```
