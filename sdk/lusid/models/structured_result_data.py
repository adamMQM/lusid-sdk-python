...
class StructuredResultData(BaseModel):
    ...
    document: constr(strict=True, max_length=256000, min_length=0) = Field(..., description="The document that will be stored (or retrieved) and which describes a unit result data entity such as a set of prices or yields")
