...
class ResultValueDictionaryAllOf(BaseModel):
    """
    ...
    __properties = ["elements", "resultValueType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResultValueDictionaryAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResultValueDictionaryAllOf:
        """Create an instance of ResultValueDictionaryAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResultValueDictionaryAllOf.parse_obj(obj)

        _obj = ResultValueDictionaryAllOf.parse_obj({
            "elements": {k: (None if v is None else ResultValue.from_dict(v)) for k, v in obj.get("elements").items()} if obj.get("elements") is not None else None,
