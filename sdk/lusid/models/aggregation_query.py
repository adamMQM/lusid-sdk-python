    ...
    def from_dict(cls, obj: dict) -> AggregationQuery:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AggregationQuery) in the input: " + obj)
        ...
        _obj = AggregationQuery.parse_obj({
            ...
            "applicable_options": {k: (None if v is None else AddressKeyOptionDefinition.from_dict(v)) for k, v in obj.get("applicableOptions").items()} if obj.get("applicableOptions") is not None else None,
        })
        return _obj
