...
class GetIndexConventionResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetIndexConventionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetIndexConventionResponse:
        """Create an instance of GetIndexConventionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetIndexConventionResponse.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in GetIndexConventionResponse) in the input: " + obj)

        _obj = GetIndexConventionResponse.parse_obj({
            "href": obj.get("href"),
            "value": IndexConvention.from_dict(obj.get("value")) if obj.get("value") is not None else None,
