...
class AddressKeyDefinition(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddressKeyDefinition:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddressKeyDefinition:
        """Create an instance of AddressKeyDefinition from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddressKeyDefinition.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AddressKeyDefinition) in the input: " + obj)

        _obj = AddressKeyDefinition.parse_obj({
