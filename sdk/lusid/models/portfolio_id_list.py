...
class PortfolioIdList(BaseModel):
    """
    PortfolioIdList
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PortfolioIdList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PortfolioIdList:
        """Create an instance of PortfolioIdList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PortfolioIdList.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PortfolioIdList) in the input: " + obj)

        _obj = PortfolioIdList.parse_obj({
