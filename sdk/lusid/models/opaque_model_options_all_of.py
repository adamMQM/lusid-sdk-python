...
class OpaqueModelOptionsAllOf(BaseModel):
    """
    ...
    __properties = ["data", "modelOptionsType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OpaqueModelOptionsAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OpaqueModelOptionsAllOf:
        """Create an instance of OpaqueModelOptionsAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OpaqueModelOptionsAllOf.parse_obj(obj)

        _obj = OpaqueModelOptionsAllOf.parse_obj({
            "data": obj.get("data"),
