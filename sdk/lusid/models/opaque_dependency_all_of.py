...
class OpaqueDependencyAllOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OpaqueDependencyAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OpaqueDependencyAllOf:
        """Create an instance of OpaqueDependencyAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OpaqueDependencyAllOf.parse_obj(obj)

        _obj = OpaqueDependencyAllOf.parse_obj({
