...
class ValuationsReconciliationRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValuationsReconciliationRequest:
    ...
    def from_dict(cls, obj: dict) -> ValuationsReconciliationRequest:
        ...
        if not isinstance(obj, dict):
            return ValuationsReconciliationRequest.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ValuationsReconciliationRequest) in the input: " + obj)

        _obj = ValuationsReconciliationRequest.parse_obj({
