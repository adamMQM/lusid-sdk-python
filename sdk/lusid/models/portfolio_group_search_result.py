...
class PortfolioGroupSearchResult(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PortfolioGroupSearchResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PortfolioGroupSearchResult:
        """Create an instance of PortfolioGroupSearchResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PortfolioGroupSearchResult.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PortfolioGroupSearchResult) in the input: " + obj)

        _obj = PortfolioGroupSearchResult.parse_obj({
            "href": obj.get("href"),
