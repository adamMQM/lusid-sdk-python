    ...
    def from_dict(cls, obj: dict) -> GetDataMapResponse:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in GetDataMapResponse) in the input: " + obj)

        _obj = GetDataMapResponse.parse_obj({
            "href": obj.get("href"),
            "values": {k: (None if v is None else DataMapping.from_dict(v)) for k, v in obj.get("values").items()} if obj.get("values") is not None else None,
