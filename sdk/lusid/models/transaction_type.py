...
class TransactionType(BaseModel):
    ...
    __properties = ["aliases", "movements", "properties", "links"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionType:
        """Create an instance of TransactionType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionType.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in TransactionType) in the input: " + obj)

        _obj = TransactionType.parse_obj({
