    ...
    def from_dict(cls, obj: dict) -> BucketedCashFlowResponse:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in BucketedCashFlowResponse) in the input: " + obj)
