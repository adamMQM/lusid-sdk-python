...
class PortfolioProperties(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PortfolioProperties:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PortfolioProperties:
        """Create an instance of PortfolioProperties from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PortfolioProperties.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PortfolioProperties) in the input: " + obj)

        _obj = PortfolioProperties.parse_obj({
            "href": obj.get("href"),
