    ...
    def from_dict(cls, obj: dict) -> PricingContext:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PricingContext) in the input: " + obj)
        ...
        _obj = PricingContext.parse_obj({
            ...
            "model_choice": {k: (None if v is None else ModelSelection.from_dict(v)) for k, v in obj.get("modelChoice").items()} if obj.get("modelChoice") is not None else None,
