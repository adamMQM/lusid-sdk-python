...
class ExerciseEventAllOf(BaseModel):
    """
    ExerciseEventAllOf
    """
    ...
    __properties = ["instrument", "eventStatus", "anchorDate", "eventWindowEnd", "instrumentEventType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExerciseEventAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExerciseEventAllOf:
        """Create an instance of ExerciseEventAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExerciseEventAllOf.parse_obj(obj)

        _obj = ExerciseEventAllOf.parse_obj({
