...
class FutureAllOf(BaseModel):
    ...
    __properties = ["startDate", "maturityDate", "identifiers", "contractDetails", "contracts", "refSpotPrice", "underlying", "calculationType", "instrumentType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FutureAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FutureAllOf:
        """Create an instance of FutureAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FutureAllOf.parse_obj(obj)

        _obj = FutureAllOf.parse_obj({
