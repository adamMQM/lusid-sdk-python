...
class OptionalityScheduleAllOf(BaseModel):
    """
    ...
    __properties = ["exerciseType", "optionEntries", "optionType", "scheduleType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OptionalityScheduleAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OptionalityScheduleAllOf:
        """Create an instance of OptionalityScheduleAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OptionalityScheduleAllOf.parse_obj(obj)

        _obj = OptionalityScheduleAllOf.parse_obj({
