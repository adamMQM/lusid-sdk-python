...
class GetCreditSupportAnnexResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetCreditSupportAnnexResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetCreditSupportAnnexResponse:
        """Create an instance of GetCreditSupportAnnexResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetCreditSupportAnnexResponse.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in GetCreditSupportAnnexResponse) in the input: " + obj)

        _obj = GetCreditSupportAnnexResponse.parse_obj({
            "href": obj.get("href"),
            "value": CreditSupportAnnex.from_dict(obj.get("value")) if obj.get("value") is not None else None,
