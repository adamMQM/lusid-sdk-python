...
class DiscountingDependencyAllOf(BaseModel):
    """
    DiscountingDependencyAllOf
    """
    currency: StrictStr = Field(..., description="The currency that needs to be discounted.")
    ...
    __properties = ["currency", "date", "dependencyType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DiscountingDependencyAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DiscountingDependencyAllOf:
        """Create an instance of DiscountingDependencyAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DiscountingDependencyAllOf.parse_obj(obj)

        _obj = DiscountingDependencyAllOf.parse_obj({
