...
class RepoAllOf(BaseModel):
    ...
    __properties = ["startDate", "maturityDate", "domCcy", "accrualBasis", "collateral", "collateralValue", "haircut", "margin", "purchasePrice", "repoRate", "repurchasePrice", "instrumentType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RepoAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RepoAllOf:
        """Create an instance of RepoAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RepoAllOf.parse_obj(obj)

        _obj = RepoAllOf.parse_obj({
