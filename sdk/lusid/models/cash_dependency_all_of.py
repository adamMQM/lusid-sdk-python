...
class CashDependencyAllOf(BaseModel):
    """
    CashDependencyAllOf
    """
    currency: StrictStr = Field(..., description="The Currency that is depended upon.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CashDependencyAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CashDependencyAllOf:
        """Create an instance of CashDependencyAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CashDependencyAllOf.parse_obj(obj)

        _obj = CashDependencyAllOf.parse_obj({
