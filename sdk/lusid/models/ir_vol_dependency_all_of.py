...
class IrVolDependencyAllOf(BaseModel):
    """
    ...
    __properties = ["currency", "volType", "date", "dependencyType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IrVolDependencyAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IrVolDependencyAllOf:
        """Create an instance of IrVolDependencyAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IrVolDependencyAllOf.parse_obj(obj)

        _obj = IrVolDependencyAllOf.parse_obj({
