...
class CdsIndexAllOf(BaseModel):
    ...
    __properties = ["startDate", "maturityDate", "flowConventions", "couponRate", "identifiers", "basket", "conventionName", "notional", "instrumentType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CdsIndexAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CdsIndexAllOf:
        """Create an instance of CdsIndexAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CdsIndexAllOf.parse_obj(obj)

        _obj = CdsIndexAllOf.parse_obj({
