...
class UpsertPortfolioTransactionsResponse(BaseModel):
    """
    ...
    __properties = ["version", "href", "metadata", "links"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpsertPortfolioTransactionsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpsertPortfolioTransactionsResponse:
        """Create an instance of UpsertPortfolioTransactionsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpsertPortfolioTransactionsResponse.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UpsertPortfolioTransactionsResponse) in the input: " + obj)

        _obj = UpsertPortfolioTransactionsResponse.parse_obj({
