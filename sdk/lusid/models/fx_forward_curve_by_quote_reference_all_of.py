...
class FxForwardCurveByQuoteReferenceAllOf(BaseModel):
    """
    ...
    __properties = ["domCcy", "fgnCcy", "tenors", "quoteReferences", "lineage", "marketDataOptions", "calendars", "spotDaysCalculationType", "marketDataType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FxForwardCurveByQuoteReferenceAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FxForwardCurveByQuoteReferenceAllOf:
        """Create an instance of FxForwardCurveByQuoteReferenceAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FxForwardCurveByQuoteReferenceAllOf.parse_obj(obj)

        _obj = FxForwardCurveByQuoteReferenceAllOf.parse_obj({
