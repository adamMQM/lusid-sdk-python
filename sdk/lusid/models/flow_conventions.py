...
class FlowConventions(BaseModel):
    ...
    __properties = ["currency", "paymentFrequency", "dayCountConvention", "rollConvention", "paymentCalendars", "resetCalendars", "settleDays", "resetDays", "leapDaysIncluded", "accrualDateAdjustment", "scope", "code"]
    ...
    def from_dict(cls, obj: dict) -> FlowConventions:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in FlowConventions) in the input: " + obj)
