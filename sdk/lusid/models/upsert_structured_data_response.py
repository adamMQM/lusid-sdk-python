...
class UpsertStructuredDataResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpsertStructuredDataResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpsertStructuredDataResponse:
        """Create an instance of UpsertStructuredDataResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpsertStructuredDataResponse.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UpsertStructuredDataResponse) in the input: " + obj)

        _obj = UpsertStructuredDataResponse.parse_obj({
            "href": obj.get("href"),
