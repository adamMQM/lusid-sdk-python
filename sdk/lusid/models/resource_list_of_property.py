...
class ResourceListOfProperty(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceListOfProperty:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceListOfProperty:
        """Create an instance of ResourceListOfProperty from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceListOfProperty.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ResourceListOfProperty) in the input: " + obj)

        _obj = ResourceListOfProperty.parse_obj({
