...
class ComplexBondAllOf(BaseModel):
    """
    ComplexBondAllOf
    """
    ...
    __properties = ["identifiers", "calculationType", "schedules", "roundingConventions", "instrumentType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ComplexBondAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ComplexBondAllOf:
        """Create an instance of ComplexBondAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ComplexBondAllOf.parse_obj(obj)

        _obj = ComplexBondAllOf.parse_obj({
