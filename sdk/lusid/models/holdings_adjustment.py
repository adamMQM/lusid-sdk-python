...
class HoldingsAdjustment(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> HoldingsAdjustment:
        ...
        if not isinstance(obj, dict):
            return HoldingsAdjustment.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in HoldingsAdjustment) in the input: " + obj)

        _obj = HoldingsAdjustment.parse_obj({
