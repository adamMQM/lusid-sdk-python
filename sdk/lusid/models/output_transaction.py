...
class OutputTransaction(BaseModel):
    ...
    instrument_uid: constr(strict=True, min_length=1) = Field(..., alias="instrumentUid", description="The unqiue Lusid Instrument Id (LUID) of the instrument that the transaction is in.")
    ...
    def from_dict(cls, obj: dict) -> OutputTransaction:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in OutputTransaction) in the input: " + obj)
