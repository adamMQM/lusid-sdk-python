...
class Abor(BaseModel):
    ...
    abor_config: Optional[ResourceId] = Field(None, alias="aborConfig")
    properties: Optional[Dict[str, ModelProperty]] = Field(None, description="Properties to add to the Abor.")
    version: Optional[Version] = None
    links: Optional[conlist(Link)] = None
    __properties = ["href", "id", "portfolioIds", "description", "aborConfig", "properties", "version", "links"]
    ...
    def from_dict(cls, obj: dict) -> Abor:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Abor) in the input: " + obj)
