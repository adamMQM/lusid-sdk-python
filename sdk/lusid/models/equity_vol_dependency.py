...
class EquityVolDependency(EconomicDependency):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EquityVolDependency:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EquityVolDependency:
        """Create an instance of EquityVolDependency from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EquityVolDependency.parse_obj(obj)

        _obj = EquityVolDependency.parse_obj({
