...
class AggregationApi(object):
    ...
    def generate_configuration_recipe(self, scope : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The scope of the portfolio")], code : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The code of the portfolio")], create_recipe_request : Annotated[Optional[CreateRecipeRequest], Field(description="The request specifying the parameters to generating the recipe")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ConfigurationRecipe, Awaitable[ConfigurationRecipe]]:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the generate_configuration_recipe_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    def get_queryable_keys(self, page : Annotated[Optional[constr(strict=True, max_length=500, min_length=1)], Field(description="The pagination token to use to continue listing queryable keys from a previous call to list queryable keys.              This value is returned from the previous call.")] = None, limit : Annotated[Optional[StrictInt], Field(description="When paginating, limit the number of returned results to this many.")] = None, filter : Annotated[Optional[constr(strict=True, max_length=16384, min_length=0)], Field(description="Expression to filter the result set.              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ResourceListOfAggregationQuery, Awaitable[ResourceListOfAggregationQuery]]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_queryable_keys_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        if async_req is not None:
            kwargs['async_req'] = async_req
    ...
    def get_valuation(self, valuation_request : Annotated[Optional[ValuationRequest], Field(description="The request specifying the set of portfolios and dates on which to calculate a set of valuation metrics")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ListAggregationResponse, Awaitable[ListAggregationResponse]]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_valuation_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        if async_req is not None:
            kwargs['async_req'] = async_req
    ...
    def get_valuation_of_weighted_instruments(self, inline_valuation_request : Annotated[Optional[InlineValuationRequest], Field(description="The request specifying the set of portfolios and dates on which to calculate a set of valuation metrics")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ListAggregationResponse, Awaitable[ListAggregationResponse]]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_valuation_of_weighted_instruments_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        if async_req is not None:
            kwargs['async_req'] = async_req
    ...
    @overload
    async def supported_analytics_internal(self, supported_analytics_internal_request : Optional[SupportedAnalyticsInternalRequest] = None, **kwargs) -> Aggregation:  # noqa: E501
        ...

    @overload
    def supported_analytics_internal(self, supported_analytics_internal_request : Optional[SupportedAnalyticsInternalRequest] = None, async_req: Optional[bool]=True, **kwargs) -> Aggregation:  # noqa: E501
        ...

    @validate_arguments
    def supported_analytics_internal(self, supported_analytics_internal_request : Optional[SupportedAnalyticsInternalRequest] = None, async_req: Optional[bool]=None, **kwargs) -> Union[Aggregation, Awaitable[Aggregation]]:  # noqa: E501
        """[INTERNAL] SupportedAnalyticsInternal: Generates a matrix of analytics features supported by LUSID.  # noqa: E501

        Breaks down, e.g. by model and instrument type, either feature groups (such as pv, accrued, risk, cashflows) that are supported or the specific address keys that are supported for them.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.supported_analytics_internal(supported_analytics_internal_request, async_req=True)
        >>> result = thread.get()

        :param supported_analytics_internal_request:
        :type supported_analytics_internal_request: SupportedAnalyticsInternalRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the supported_analytics_internal_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.supported_analytics_internal_with_http_info(supported_analytics_internal_request, **kwargs)  # noqa: E501

    @validate_arguments
    def supported_analytics_internal_with_http_info(self, supported_analytics_internal_request : Optional[SupportedAnalyticsInternalRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """[INTERNAL] SupportedAnalyticsInternal: Generates a matrix of analytics features supported by LUSID.  # noqa: E501
        ...
        >>> thread = api.supported_analytics_internal_with_http_info(supported_analytics_internal_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Aggregation, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'supported_analytics_internal_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method supported_analytics_internal" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['supported_analytics_internal_request'] is not None:
            _body_params = _params['supported_analytics_internal_request']
        ...
        return self.api_client.call_api(
            '/api/aggregation/supportedanalyticsinternal', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
